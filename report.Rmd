...
#```{r, echo=FALSE}
#Sys.setenv("plotly_username"="lysethan")
#Sys.setenv("plotly_api_key"="2xTbFH705WoS1d0k6UEg")
#```
...
func = c("data readin",
         ...
         "render R data frames to tables",
         "render rmarkdown files to htmls, pdfs, etc.",
         "handle strings in R",
         "render data frames to publish-style tables",
         "themes for ggplot graphics",
         "tool for graphics scaling",
         "generate word cloud",
         "arrange ggplot objects")
df = data.frame(packages=pkgs,functions=func )
kable(df)
```
...
ggsave("tendency.png",plot=p)
```

```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("tendency.png")
```
...
#plotly_IMAGE(fig, width = 700, height = 500, format = "png", scale = 2,
#             out_file = "./race.png")
```
...
#plotly_IMAGE(p3, width = 700, height = 500, format = "png", scale = 2,
#             out_file = "./infection_rate.png")
```
